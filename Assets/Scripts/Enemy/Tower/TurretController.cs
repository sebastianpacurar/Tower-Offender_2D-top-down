...
namespace Enemy.Tower {
    public class TurretController : MonoBehaviour {
        ...
        private void Awake() {
            ...
            container.name = $"{container.name} - {transform.position.ToString()}";
        ...
        private void Shoot() {
            ...
            if (!_canFire) {
                ...
                Instantiate(turretStatsSo.ShellPrefab, turretEdge.position, Quaternion.identity, shellsContainer.transform);
            }
        }
    }
}